...
//   final DetealsModle deteals;

//   HomeScreen({required this.deteals});
...
//         child: Column(
//           children: [
//             Text('Email: ${deteals.email}'),
//             Text('Password: ${deteals.password}'),
//             Text('Name: ${deteals.name}'),
//             Text('Phone: ${deteals.phone}'),
//           ],
//         ),
//       ),
//     );
